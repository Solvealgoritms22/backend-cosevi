...
INSERT INTO "new_Visit" ("accessCode", "createdAt", "entryTime", "exitTime", "hostId", "id", "licensePlate", "qrCode", "status", "updatedAt", "validFrom", "validUntil", "visitorId", "visitorIdNumber", "visitorName") SELECT "accessCode", "createdAt", "entryTime", "exitTime", "hostId", "id", "licensePlate", "qrCode", "status", "updatedAt", "validFrom", "validUntil", "visitorId", "visitorIdNumber", "visitorName" FROM "Visit";
DROP TABLE "Visit";

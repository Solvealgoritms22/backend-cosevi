...
INSERT INTO "new_Visit" ("accessCode", "companionCount", "createdAt", "entryTime", "exitTime", "hostId", "id", "images", "licensePlate", "qrCode", "spaceId", "status", "updatedAt", "validFrom", "validUntil", "visitorId", "visitorIdNumber", "visitorName") SELECT "accessCode", "companionCount", "createdAt", "entryTime", "exitTime", "hostId", "id", "images", "licensePlate", "qrCode", "spaceId", "status", "updatedAt", "validFrom", "validUntil", "visitorId", "visitorIdNumber", "visitorName" FROM "Visit";
DROP TABLE "Visit";
